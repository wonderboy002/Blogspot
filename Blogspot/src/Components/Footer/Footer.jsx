...
export default function Footer() {
  return (
    <footer className="bg-white dark:bg-indigo-950  border-y">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <a className="flex items-center">
              <img
                ...
                className="mr-3 h-40 rounded-full"
                alt="Logo"
              />
            </a>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              <h2 className="mb-6 text-sm dark:text-white font-semibold text-gray-900 uppercase">
                Resources
              </h2>
            ...
            <div>
              ...
              <ul className="text-gray-500 dark:text-white font-medium">
                <li className="mb-4">
                  <a
                    href="https://github.com/wonderboy002"
                ...
                <li>
                  <a
                    href="https://www.instagram.com/wonder_boy_2206/"
                    className="hover:underline"
                    target="_blank"
                  >
                    Instagram
